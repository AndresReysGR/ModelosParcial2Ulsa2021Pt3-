...
class ListaRestaurantesController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        restaurantes.append(Restaurante(nombre: "Piltover y Zaun" , direccion: "Calle Dos #123", horario: "De 12pm a 10pm", foto: "Demacia"))
        restaurantes.append(Restaurante(nombre: "Jonia" , direccion: "Calle tres #456", horario: "De 10am a 4pm", foto: "Jonia"))
        restaurantes.append(Restaurante(nombre: "Demacia" , direccion: "Calle cuatro #456", horario: "De 12pm a 3pm",  foto: "Piltover_y_Zaun"))
